...
const privateKey = fs.readFileSync('/etc/letsencrypt/live/berlinpoolbistro.online/privkey.pem', 'utf8');
const certificate = fs.readFileSync('/etc/letsencrypt/live/berlinpoolbistro.online/fullchain.pem', 'utf8');
...
http.createServer((req, res) => {
  res.writeHead(301, { "Location": "https://" + req.headers['host'] + ":" + port + req.url }); // Tambahkan port di redirect
  res.end();
}).listen(80, () => {
